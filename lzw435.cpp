/*
   ...
   driver for the lzw compression algorithm Part 1
*/

#include "lzwAlgorithm435.hpp"
...
int main(int argc, char* argv[]) 
{
   ...
   std::cout << "|                                                                |" << std::endl;
   std::cout << "| 3460:435/535 Algorithms Project Two Part One - LZW Compression |" << std::endl;
